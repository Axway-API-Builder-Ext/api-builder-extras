...
describe('Search tests', () => {
	...
	describe('#search actions', () => {
		it('should pass without any given parameter', async () => {
			const mockedFn = setupElasticsearchMock(client, 'search', './test/unit/mock/search_all_response.json');
		...
		it('should fail with an invalid sort key given', async () => {
			const mockedFn = setupElasticsearchMock(client, 'search', './test/unit/mock/wrong_sort_column.json', true);
		...
		it('should return with missing index, if the index does not exists', async () => {
			const mockedFn = setupElasticsearchMock(client, 'search', './test/unit/mock/search/index_not_found_response.json');
		...
		it('should return with no result, if the query has no hits.', async () => {
			const mockedFn = setupElasticsearchMock(client, 'search', './test/unit/mock/search/not-hit-response.json');
		...
		it('should be okay having suggest_field and suggest_text only, as suggest_mode defaults to missing', async () => {
			const mockedFn = setupElasticsearchMock(client, 'search', './test/unit/mock/suggest_response.json');
			const inputParameter = {
